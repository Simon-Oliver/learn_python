...
# def get_exchange():
#     xml = requests.get('http://www.pwebapps.ezv.admin.ch/apps/rates/rate/getxml?activeSearchType=today')
...
#         kurs = devise.find('{http://www.pwebapps.ezv.admin.ch/apps/rates}kurs').text
#         if(name == 'aud'):
#         return(kurs)
